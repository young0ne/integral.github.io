$(document).ready(function(){
  ...
  var txtAni = function(){
    $('.main-txt').show().stop(true).delay(600).animate({'opacity':1}, 700, lineAni)
  }

  var lineAni = function(){
    $('.line').stop(true).delay(600).animate({'width':'90%'}, 1000, inLineAni);
  }

  var inLineAni = function(){
    $('.in-line').stop(true).delay(300).animate({'height':'50px'}, 500, titleAni);
  }
  
  var titleAni = function(){
    $('.title').show().stop(true).delay(100).animate({'opacity':1}, 300);
  }
  ...
  var word = [ "INTEGRAL STUDIO", "INTEGRAL STUDIO" ];
  var nextWord = 1;
